...
Haikal.on('group-participants-update', async (anu) => {
	try {
		...
		console.log(anu)
		if (anu.action == 'setdesc') {
                if (Haikal.groupUpdateDescription(anu.jid)) {
                Haikal.groupUpdateSubject(anu.jid)
                }
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/setdes.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jm} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER + ${behys}' -pointsize 63 -annotate +460+200 'Welcome To ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil5.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil5.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Hello Seseorang Sudah Mengubah Description Group 🗿
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
JANGAN_LUPA_SUBSCRIBE : https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Nah Dia Orang Nya 🗿 @${num.split('@')[0]}`, contextInfo: { mentionedJid: [num] }})
			})
		} else if (anu.action == 'setname') {
		num = anu.participants[0]
		hesa = `${num}`
		  mestes = (teks) => {
					return teks.replace(/['@s whatsapp.net']/g, " ");
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/grname.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jamny} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER - ${behys}' -pointsize 63 -annotate +460+200 'Leaving from ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil4.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil4.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Hello Seseorang Telah Mengubah Nama Group 🗿
┏━━⊱
┣❏SUBSCRIBE : https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Nah Dia Orang nya 🗿  @${num.split('@')[0]}\n`, contextInfo: { mentionedJid: [num] }})
			})
		}
	} catch (e) {
		console.log(e)
...
Haikal.on('group-participants-update', async (anu) => {
	try {
		...
		if (anu.action == 'promote') {
                if (Haikal.groupMakeAdmin(anu.jid)) {
                Haikal.groupDemoteAdmin(anu.jid)
                }
			num = anu.participants[0]
			hesa = `${num}`
		  mestes = (teks) => {
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/promote.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jm} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER + ${behys}' -pointsize 63 -annotate +460+200 'Welcome To ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil2.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil2.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Hello selamat Yah 🤟
Jadilah Admin Yang Bijak Dan Dewasa Okey 🗿
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
JANGAN_LUPA_SUBSCRIBE : https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
SELAMAT ANDA MENJADI ADMIN DI GROUP INI @${num.split('@')[0]}`, contextInfo: { mentionedJid: [num] }})
			})
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/demote.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jamny} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER - ${behys}' -pointsize 63 -annotate +460+200 'Leaving from ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil3.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil3.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
KASIAN DI DEMOTE MAKANYA HARUS JADI ADMIN GANTENG DAN CANTIK :v 😂
┏━━⊱
┣❏SUBSCRIBE : https://youtube.com/channel/UCa37vxxUI-XULKw_sHb4A5g
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
YAHAHAHAH KASIAN DI DEMOTE👋🏻*@${num.split('@')[0]}\n`, contextInfo: { mentionedJid: [num] }})
			})
		}
	} catch (e) {
		console.log(e)
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/wel.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jm} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER + ${behys}' -pointsize 63 -annotate +460+200 'Welcome To ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
SELAMAT DATANG
┏━━⊱
┣❏NAMA :   
...
pushnem = Haikal.contacts[num] != undefined ? Haikal.contacts[num].notify = undefined ? PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international') : Haikal.contacts[num].notify || Haikal.contacts[num].vname : PhoneNumber('+' + num.replace('@s.whatsapp.net', '')).getNumber('international')
			try {
				...
				exec(`magick './media/image/lev.jpg' -gravity west -fill '#ffffff' -font './media/font/font-gue.ttf' -size 1280x710 -pointsize 75 -interline-spacing 7.5 -annotate +460-47 '${resa}' -pointsize 51 -annotate +460+83 '${jamny} ${calender}' -pointsize 48 -annotate +100+230 'MEMBER - ${behys}' -pointsize 63 -annotate +460+200 'Leaving from ${mdata.subject}' '${ppimg}' -resize %[fx:t?u.w*0.2:u.w]x%[fx:?u.h*0.2:u.h] -gravity center -geometry -430+66 -composite './stik/hasil1.jpg'`)
				.on('error', () => Haikal.sendMessage(m.chat, 'error', MessageType.text))
				.on('exit', () => {
			Haikal.sendMessage(mdata.id, fs.readFileSync('./stik/hasil1.jpg'), MessageType.image, {caption: `*MY NAME HW MODS BOT*
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱
