...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
						"videoMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AvgFyt-WgEogQ_7JrX5QlF7SYJ0UfxYVJjmE_Ev_6qFK.enc",
						"mimetype": "video/mp4",
						"fileSha256": "gm2K0ncVE7YW8z8n0CWIbVBr/s+ZrA4pVj5EzKaojvE=",
						"fileLength": "5474586",
						"seconds": 23,
						"mediaKey": "thqUd+u4BF56j29YiNGozkBOCIVRh4axkhLM1Bx+lPA=",
						"caption": "XHIRO MHONSHINE 🔥",
						"height": 640,
						"width": 352,
						"fileEncSha256": "7DfrAtmRUb4uk9L0WbPHXKfglYUXkrRRcU76GIxgZgw=",
						"directPath": "/v/t62.7161-24/13761672_361126305695879_3210908730969687904_n.enc?ccb=11-4&oh=0bf3bf6b3862218d3765a655af532e51&oe=61845A31",
						"mediaKeyTimestamp": "1633706537"
					 },
						"contentText": `❏HW MODS WA❏
▬▭▬▭▬▭▬▭▬▬▭▬▭
Hai ${pushname}
...
break
                   ...
                   Haikal.sendMessage(from, anu1, image, {caption: `nihh kack`, quoted: ikal})
                   break
                   case 'jokes':  
                   if (isBan) return reply(mess.ban)
                   freply(`WAIT KAK CANTIK/GANTENG`)
                   ...
                   Haikal.sendMessage(from, anu, image, {caption: `nihh kack`, quoted: ikal})
                   break
                   case 'neon2':  
                   if (isBan) return reply(mess.ban)
                   if (args.length < 1) return freply(`[❗] CONTOH??\n*${prefix}${command} Haikal*`)
