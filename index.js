...
module.exports = Haikal = async (Haibugtrol, bugtrol) => {
	try {
...
Haikal.sendMessage(kal.key.remoteJid, tekuss, MessageType.text, {contextInfo:{mentionedJid:[nums + "@s.whatsapp.net"]}})
                ...
                global.blocked
                m = simple.smsg(Haibugtrol, bugtrol)
...
//=================================================//
        ...
        const mentions = (teks, memberr, id) => {
            (id == null || id == undefined || id == false) ? Haikal.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : Haikal.sendMessage(from, teks.trim(), extendedText, { quoted: bugtrol, contextInfo: { "mentionedJid": memberr } })
        }        
        ...
        const fakethumb = (teks, yes) => {
            Haikal.sendMessage(from, teks, image, {thumbnail:Mfake,quoted:bugtrol,caption:yes})
        }
const fekekal = (teks, yes) => {        	
Haikal.sendMessage(from,teks,image,{mimetype: Mimetype.fekebugtrol,quoted : bugtrol, thumbnail: fs.readFileSync('./stik/deden.jpeg')})            
        }         
        ...
        const sendStickerFromUrl = async(to, url) => {
                ...
                download(url, './database/sampah' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${filess} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${asw}`, (err) => {
                        ...
                        Haikal.sendMessage(to, media, MessageType.sticker,{quoted:bugtrol})
...
includeStarred: false
        ...
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
                ...
                download(url, filename, async function () {
                    ...
                    Haikal.sendMessage(to, media, type, { quoted: bugtrol, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
const checkWin = (sender) => {
        ...
        return Haikal.sendMessage(from, teks, text, {quoted:bugtrol, contextInfo:{mentionedJid: [orangnye]}}).then(() => {
        ...
        if (tictactoe.hasOwnProperty(senderNumber) && ["1", "2", "3", "4", "5", "6", "7", "8", "9"].includes(budy) && !isCmd) {
            ...
            if (win) {
                ...
                if (win == mode) {
                    ...
                    return Haikal.sendMessage(from, teks, text, {quoted:bugtrol, contextInfo:{mentionedJid: [player1 + "@s.whatsapp.net", player2 + "@s.whatsapp.net"]}}).then(() => {
	...
	if (sender == `${tttSkuy.Y}@s.whatsapp.net` && budy.toLowerCase() == 'y') {
		...
		nantang = O
                ...
                return Haikal.sendMessage(from, tesk, text, {quoted:bugtrol, contextInfo:{mentionedJid: [penantang, lawan]}}).then(() => {
                    var data = {}
		...
		Haikal.sendMessage(from, `「 *Game Tictactoe Rejected* 」\n\n• @${tttSkuy.Y} yahaha cupu lo`, text, {quoted: bugtrol, contextInfo: { mentionedJid: [tttSkuy.Y + "@s.whatsapp.net"]}})
		fs.unlinkSync("./temp/" + from + ".json");
	}
}
		// MUTE
...
break
                   ...
                   Haikal.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so cantik`, quoted: bugtrol})
                   break                                      
                   case 'KEREN':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/birb`)
                   anu1 = await getBuffer(anu.link)
                   Haikal.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so keren`, quoted: bugtrol})
                   break
                   case 'GANTENG':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/koala`)
                   anu1 = await getBuffer(anu.link)
                   Haikal.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu so ganteng`, quoted: bugtrol})
                   break
}
//switch Botton
switch (isStMsg) {
...
if (isBan) return reply(mess.ban)
                   ...
                   anu1 = await getBuffer(anu.link)
                   Haikal.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu`, quoted: bugtrol})
                   break                   
                   case 'cat':  
                   if (isBan) return reply(mess.ban)
                   anu = await fetchJson(`https://some-random-api.ml/img/cat`)
                   ...
                   Haikal.sendMessage(from, anu1, image, {caption: `nih kak`, quoted: bugtrol})
                   break
case 'smeme':
if (isBan) return reply(mess.ban)
pe = args.join('')
...
break
   ...
   if (isBan) return reply(mess.ban)
            ...
            Haikal.sendMessage(from,{url:images},image,{quoted:bugtrol})
            });
            break
case 'attp':
if (isBan) return reply(mess.ban)
					...
					Haikal.sendMessage(from, atetepe, sticker, { quoted: bugtrol })
					break
case 'darkjokes':
if (isBan) return reply(mess.ban)
...
Haikal.sendMessage(from, hasil, image, {quoted: bugtrol})
break
                   case 'memeindo':  
                   if (isBan) return reply(mess.ban)
                   ...
                   Haikal.sendMessage(from, anu1, image, {caption: `nihh kack`, quoted: bugtrol})
                   break
                   case 'jokes':  
                   if (isBan) return reply(mess.ban)
                   freply(`WAIT KAK CANTIK/GANTENG`)
                   ...
                   Haikal.sendMessage(from, anu, image, {caption: `nihh kack`, quoted: bugtrol})
                   break
                   case 'neon2':  
                   if (isBan) return reply(mess.ban)
                   if (args.length < 1) return freply(`[❗] CONTOH??\n*${prefix}${command} Haikal*`)
...
if (isBan) return reply(mess.ban)
                    ...
                    Haikal.sendMessage(from, anu, image, {caption: `Nih Kak`, quoted: bugtrol})
                    break
case 'nulis2':  
if (isBan) return reply(mess.ban)
...
if (isBan) return reply(mess.ban)
                ...
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www2.zippyshare.com/d/z9dcY6Nr/791216/%5bNekoPoi%5d_Akina_to_Onsen_de_H_Shiyo%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
case 'nekopoi1':
if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www4.zippyshare.com/d/j7PFLGUY/946757/%5bNekoPoi%5d_Tsuma_ga_Kirei_ni_Natta_Wake_-_02_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi3':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www111.zippyshare.com/d/EK5uqIMh/566060/%5bNekoPoi%5d_Megane_no_Megami_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi4':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www109.zippyshare.com/d/2ebALhhS/463654/%5bNekoPoi%5d_Watashi_ga_Toriko_-_02%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi5':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getbuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www115.zippyshare.com/d/LmzOkRAI/313299/%5bNekoPoi%5d_Chichi-iro_Toiki_-_01_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi6':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www89.zippyshare.com/d/SgEHvrJs/42812/%5bNekoPoi%5d_Chichi-iro_Toiki_-_02_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi7':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www66.zippyshare.com/d/j0ivbciL/520411/%5bNekoPoi%5d_Onna_Maou_Melissa_no_H_na_Boukenki_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi8':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www71.zippyshare.com/d/M225YIrR/535656/%5bNekoPoi%5d_Buta_no_Gotoki_Sanzoku_ni_Torawarete_Shojo_wo_Ubawareru_Kyonyuu_Hikalishi_Onna_Senshi_-_01%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break
                 case 'nekopoi9':
                 if (isBan) return reply(mess.ban)
                 try {
				...
				fcrew = await getBuffer(pporang)
                ini_buffer = await getBuffer("https://i.pinimg.com/originals/33/3d/a0/333da04b420fbd824381385e6abe248f.jpg")
                Haikal.sendMessage(from, fcrew, MessageType.image, {quoted: bugtrol, caption: 'NIH LINKNYA: https://www49.zippyshare.com/d/bdwYjaXS/605790/%5bNekoPoi%5d_Akebi_no_Hana___Maho_-_01_%5b360P%5d_%5bnekopoi.pro%5d.mp4\n\nNOTE SIAPKAN TISU & JANGAN LUPA GUNAKAN VPN'})
                  break                 
                  //NSFw
case 'yuri':
...
Haikal.sendMessage(from, anu, image, { quoted: bugtrol, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'anal':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, kon, image, { quoted: bugtrol, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, hai, image, { quoted: bugtrol, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, buffer, image, { quoted: bugtrol, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
${descOwner ? `*Desc diubah oleh* : @${descOwner.split('@')[0]}` : '*Desc diubah oleh* : -'}\n*Tanggal* : ${descTime ? `${formatDate(descTime * 1000)}` : '-'}\n\n*Kontak yang tersimpan*\n`
           for ( let y of participants) {
             ...
             Haikal.sendMessage(from,par,text,{quoted:bugtrol,contextInfo:{mentionedJid:jids}})
             } catch {
             freply('Link error')
             }
             break
...
Haikal.sendMessage(from, ' Succes change description group', text, {quoted:bugtrol})
break
...
Haikal.sendMessage(from, ' Succes change name group', text, {quoted:bugtrol})
break
...
Haikal.sendMessage(from, buffergbl, image, {quoted: bugtrol, caption: `\`\`\`「 Group Info 」\`\`\`\n*•> Name* : ${groupName}\n*•> Member* : ${groupMembers.length}\n*•> Admin* : ${groupAdmins.length}\n*•> Description* : \n${groupDesc}`})
break
...
Haikal.sendMessage(from, teks, text, {quoted:bugtrol, contextInfo:{mentionedJid:[mentionede]}})
break
case 'listadmin':
...
Haikal.sendMessage(from, yeh, text, { quoted: bugtrol })
break
...
Haikal.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil dibanned`, text, {quoted:bugtrol, contextInfo:{mentionedJid:[orgnye]}})
Haikal.sendMessage(`6285714170944@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Banned`, text, {quoted:bugtrol, contextInfo:{mentionedJid:[orgnye]}})
} else if (args[0] === "del") {
if (!isBane) return reply('User tidak dibanned')
let delbans = banUser.indexOf(orgnye)
banUser.splice(delbans, 1)
fs.writeFileSync('./database/banned.json', JSON.stringify(banUser))
Haikal.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil diunban`, text, {quoted:bugtrol, contextInfo:{mentionedJid:[orgnye]}})
Haikal.sendMessage(`6285714170944@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Unbanned`, text, {quoted:bugtrol, contextInfo:{mentionedJid:[orgnye]}})
} else {
...
Haikal.sendMessage(from, thumb, MessageType.image, {quoted: bugtrol, caption: "Nih kak..."})
break
// Get Pic ( HW MODS WA )
case 'getpic':
if (isBan) return reply(mess.ban)
...
if (err) return Haikal.sendMessage(from, `${err}`, text, { quoted: bugtrol })
if (stdout) {
console.log('Restart...')
}
})
...
// Voice Google 
case 'tts':
					if (args.length < 1) return Haikal.sendMessage(from, `Kode bahasanya mana kak? contoh : ${prefix}tts id yamate kudasai`, text, { quoted: bugtrol })
				   const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return Haikal.sendMessage(from, `Teksnya mana kak? contoh : ${prefix}tts id yamate kudasai`, text, { quoted: bugtrol })
					...
					bby.length > 300
						...
						: gtts.save(ranm, bby, function () {
							exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
								...
								Haikal.sendMessage(from, buff, audio, {  ptt: true, quoted: bugtrol })
								fs.unlinkSync(rano)
							})
						})
					break
...
Haikal.sendMessage(from, jadie, audio, {mimetype: 'audio/mp4', ptt: true, quoted: bugtrol})
fs.unlinkSync(rname)
})
break
case 'setbio':
...
Haikal.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:bugtrol})
fs.unlinkSync(media)
break
...
cokmatane = Number(args[0])
hah = fs.readFileSync(media)
Haikal.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: bugtrol})
fs.unlinkSync(media)
break
// Sider ( HW MODS WA )
case 'sider':
...
infom = await Haikal.messageInfo(from, bugtrol.message.extendedTextMessage.contextInfo.stanzaId)
hemm = infom.reads
...
Haikal.sendMessage(from, teksx, text, { sendEphemeral: true, quoted: bugtrol, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readdin }})
Haikal.sendMessage(from, teksx1, text, { sendEphemeral: true, quoted: bugtrol, thumbnail: Bfake, contextInfo: { forwardingScore:999, isForwarded:true, mentionedJid: readon }})
} catch(e) {
...
Haikal.sendMessage(from, starGame, text, {quoted: bugtrol, contextInfo: { mentionedJid: [sender, args[0].replace("@", "") + "@s.whatsapp.net"],}})
break
...
beks = `@${noes.split("@")[0]}`
Haikal.sendMessage(from, beks, text, {quoted:bugtrol, contextInfo:{mentionedJid:[noes]}})                
break
...
Haikal.sendMessage(from, teks, text, {quoted:bugtrol, contextInfo:{mentionedJid:[fkhs], "externalAdReply":flink}})
break
    case 'off':
            if (!kal.key.fromMe && !isOwner) return 
            offline = true
...
if (isBan) return reply(mess.ban)
			...
			require('./lib/fetcher.js').modStick(media, Haibugtrol, bugtrol, from)
			break
	case 'stikerwm':
	case 'stickerwm':
    case 'swm':
if (isBan) return reply(mess.ban)
            ...
            .on('error', (e) => {
            console.log(e)
            Haikal.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: bugtrol })
            fs.unlinkSync(media)
            })
            .on('end', () => {
            _out = getRandom('.webp')
            ...
            .on('exit', () => {
            Haikal.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: bugtrol })
            fs.unlinkSync(out)
            fs.unlinkSync(_out)
            fs.unlinkSync(media)
            })
    ...
    case 'upswimage':
            ...
            Haikal.sendMessage(from, bur, text, { quoted: bugtrol })
            } else {
...
case 'tagall3':
					...
					Haikal.sendMessage(from, teks, text, {detectLinks: false, quoted: bugtrol})
					break
    case 'tagall':
            if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
            if (!isGroup) return freply(mess.only.group)
    ...
    case 's':
            ...
            const media = await Haikal.downloadAndSaveMediaMessage(encmedia)
                ...
                .on('end', function () {
                console.log('Finish')
                Haikal.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: bugtrol})
                 fs.unlinkSync(media)
                fs.unlinkSync(ran)
                })
                .addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
...
anu = res.nowm
fto = Mthumb
Haikal.sendMessage(from, fto, image, {quoted:bugtrol, caption:`*TIKTOK MP3*\n\n•> Nowm : ${res.nowm}\n•> Wm : ${res.wm}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(anu)
Haikal.sendMessage(from, khs, audio, {quoted:bugtrol, mimetype:'audio/mp4', filename:'Haikalgans.mp3', ptt:true})
})
break
    case 'toimg':
...
break
    case 'brainly':
			...
			Haikal.sendMessage(from, teks, text,{quoted:bugtrol,detectLinks: false})                        
            })              
			break
	case 'term':
                        if (!kal.key.fromMe && !isOwner) return
...
case 'ig':
	    ...
	    Haikal.sendMessage(from,igvdl,video,{mimetype:'video/mp4',quoted:bugtrol,caption:'Nih'})
            } else if (ink.includes('.jpg')){
            const igpdl = await getBuffer(ink)
            Haikal.sendMessage(from,igpdl,image,{mimetype:'image/jpeg',quoted:bugtrol,caption:'Nih'})
	    }
            }
	    })
	    break
...
case 'tovoice':
            ...
            Haikal.sendMessage(from, buffer453, MessageType.audio, {quoted: bugtrol, mimetype: 'audio/mp4', ptt:true})
            fs.unlinkSync(ran)
            })
            break
    case 'tomp3':
            ...
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            Haikal.sendMessage(from, buffer453, audio, { mimetype: 'audio/mp4', quoted: bugtrol })
            fs.unlinkSync(ran)
            })
            break
    case 'fast':
            ...
            if (err) return fakegroup(`Err: ${err}`)
            buffer453 = fs.readFileSync(ran)
            Haikal.sendMessage(from, buffer453, video, { mimetype: 'video/mp4', quoted: bugtrol })
            fs.unlinkSync(ran)
            })
            break
    case 'slow':
...
Haikal.sendMessage(from, fto, image, {quoted:bugtrol, caption:`*FACEBOOK MP4*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
case 'fbmp3':
...
Haikal.sendMessage(from, fto, image, {quoted:bugtrol, caption:`*FACEBOOK MP3*\n\n•> Normal : ${res.Normal_video}\n•> Hd : ${res.HD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
Haikal.sendMessage(from, khs, audio, {quoted:bugtrol, mimetype:'audio/mp4', filename:'Haikal.mp3', ptt:true})
})
break
case 'ytmp3':
if (isBan) return reply(mess.ban)
...
Haikal.sendMessage(from, fak, MessageType.image, {quoted:bugtrol, caption:captions})
...
Anu = res.SD
fto = Mthumb
Haikal.sendMessage(from, fto, image, {quoted:bugtrol, caption:`*TWITTER MP4*\n\n•> Hd : ${res.HD}\n•> Sd : ${res.SD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
sendMediaURL(from, Anu, 'Done!')
})
break
// Twitter Downloader ( HW MODS WA )
...
Anu = res.SD
fto = Mthumb
Haikal.sendMessage(from, fto, image, {quoted:bugtrol, caption:`*TWITTER MP3*\n\n•> Hd : ${res.HD}\n•> Sd : ${res.SD}\n•> Audio : ${res.audio}\n\n_Please wait, the media file is being sent it may take a few minutes_`, thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true}})
khs = await getBuffer(Anu)
Haikal.sendMessage(from, khs, audio, {mimetype:'audio/mp4', filename:'Haikalgan.mp3', quoted:bugtrol, ptt:true})
})
break
...
if (!kal.key.fromMe && !isOwner) return
try {
return Haikal.sendMessage(from, JSON.stringify(eval(budy.slice(2)),null,'\t'),text, {quoted: bugtrol})
} catch(err) {
e = String(err)
reply(e)
}
...
Haikal.sendMessage(from, sendNye, sticker, {quoted:bugtrol, contextInfo:{forwardingScore: 800, isForwarded: true}})
}
